        ...
        {!isOpen && (
          ...
          >
            <button
              ...
              className="group relative flex items-center justify-center w-16 h-16 sm:w-20 sm:h-20 rounded-full bg-[#111115]/90 hover:bg-[#18181f] border-2 border-white/20 hover:border-[#f05a28] shadow-[0_15px_40px_rgba(0,0,0,0.5)] backdrop-blur-xl transition-all duration-300 hover:-translate-y-1 hover:scale-105 hover:shadow-[0_15px_40px_rgba(240,90,40,0.4)] cursor-pointer p-3"
              aria-label="Open AI Chatbot"
            >
              {/* Glowing Pulse Online Dot */}
              <div className="absolute top-0.5 right-0.5 z-10 flex items-center justify-center">
                <span className="w-3.5 h-3.5 rounded-full bg-emerald-500 border-2 border-[#111115]" />
                <span className="absolute w-3.5 h-3.5 rounded-full bg-emerald-400/70 animate-ping" />
              </div>
              ...
              <img 
                src="/chatboticon.png" 
                alt="AI Chatbot" 
                className="w-full h-full object-contain rounded-full group-hover:scale-110 transition-transform duration-300 filter drop-shadow-md" 
              />
            </button>
          </motion.div>
        )}
          ...
          >
            ...
            <div className="px-5 py-4 bg-gradient-to-r from-[#14141c] to-[#0d0d11] border-b border-white/10 flex items-center justify-between shrink-0">
              <div className="flex items-center gap-3">
                <div className="w-10 h-10 rounded-full bg-white/5 border border-white/20 flex items-center justify-center p-1 shadow-md shadow-orange-500/10">
                  <img src="/chatboticon.png" alt="Chatbot Icon" className="w-full h-full object-contain rounded-full" />
                </div>
                <div>
            ...
            <div className="flex-1 p-4 overflow-y-auto space-y-3.5 max-h-[280px] sm:max-h-[320px] scrollbar-thin">
              {messages.map((msg) => (
                ...
                >
                  {msg.sender === 'bot' && (
                    <div className="w-7 h-7 rounded-full bg-white/5 border border-white/20 flex items-center justify-center p-0.5 shrink-0 mt-0.5 shadow-sm">
                      <img src="/chatboticon.png" alt="AI Avatar" className="w-full h-full object-contain rounded-full" />
                    </div>
                  )}
              ...
              {isTyping && (
                ...
                >
                  <div className="w-7 h-7 rounded-full bg-white/5 border border-white/20 flex items-center justify-center p-0.5 shrink-0 shadow-sm animate-pulse">
                    <img src="/chatboticon.png" alt="AI Avatar" className="w-full h-full object-contain rounded-full" />
                  </div>
